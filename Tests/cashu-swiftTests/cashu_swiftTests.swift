...
//    }
    ...
    func testKeysetIDV1Vector1() throws {
        ...
        let expectedID = "00456a94ab4e1c46"
        
        let calculatedID = try CashuSwift.Keyset.calculateHexKeysetID(keyset: keys)
        XCTAssertEqual(calculatedID, expectedID)
    }
    
    func testKeysetIDV1Vector2() throws {
        // Test vector from https://github.com/cashubtc/nuts/blob/main/tests/02-tests.md
        let keys: [String: String] = [
        ...
        let expectedID = "000f01df73ea149a"
        
        let calculatedID = try CashuSwift.Keyset.calculateHexKeysetID(keyset: keys)
        XCTAssertEqual(calculatedID, expectedID)
    }
    
    func testKeysetIDV2Vector1() throws {
        // Test vector from https://github.com/cashubtc/nuts/blob/main/tests/02-tests.md
        // Vector 1: unit=sat, input_fee_ppk=100, final_expiry=2059210353
        let keys: [String: String] = [
            "1": "03a40f20667ed53513075dc51e715ff2046cad64eb68960632269ba7f0210e38bc",
            "2": "03fd4ce5a16b65576145949e6f99f445f8249fee17c606b688b504a849cdc452de",
            "4": "02648eccfa4c026960966276fa5a4cae46ce0fd432211a4f449bf84f13aa5f8303",
        ...
        let expectedID = "015ba18a8adcd02e715a58358eb618da4a4b3791151a4bee5e968bb88406ccf76a"
        
        let calculatedID = try CashuSwift.Keyset.calculateHexKeysetIDv2(keyset: keys,
                                                                        unit: "sat",
                                                                        inputFeePPK: 100,
    ...
    func testKeysetIDV2Vector2() throws {
        // Test vector from https://github.com/cashubtc/nuts/blob/main/tests/02-tests.md
        // Vector 2: unit=sat, input_fee_ppk=0 (omitted), final_expiry=2059210353
        let keys: [String: String] = [
            "1": "03ba786a2c0745f8c30e490288acd7a72dd53d65afd292ddefa326a4a3fa14c566",
            "2": "03361cd8bd1329fea797a6add1cf1990ffcf2270ceb9fc81eeee0e8e9c1bd0cdf5",
            "4": "036e378bcf78738ddf68859293c69778035740e41138ab183c94f8fee7572214c7",
        ...
        let expectedID = "01ab6aa4ff30390da34986d84be5274b48ad7a74265d791095bfc39f4098d9764f"
        
        // input_fee_ppk=0 should be omitted from preimage
        let calculatedID = try CashuSwift.Keyset.calculateHexKeysetIDv2(keyset: keys,
                                                                        unit: "sat",
                                                                        inputFeePPK: 0,
                                                                        finalExpiry: 2059210353)
    ...
    func testKeysetIDV2Vector3() throws {
        // Test vector from https://github.com/cashubtc/nuts/blob/main/tests/02-tests.md
        // Vector 3: unit=sat, input_fee_ppk=0 (omitted), no final_expiry
        let keys: [String: String] = [
            "1": "03ba786a2c0745f8c30e490288acd7a72dd53d65afd292ddefa326a4a3fa14c566",
            "2": "03361cd8bd1329fea797a6add1cf1990ffcf2270ceb9fc81eeee0e8e9c1bd0cdf5",
            "4": "036e378bcf78738ddf68859293c69778035740e41138ab183c94f8fee7572214c7",
        ...
        let expectedID = "012fbb01a4e200c76df911eeba3b8fe1831202914b24664f4bccbd25852a6708f8"
        
        // Both input_fee_ppk=0 and final_expiry=nil should be omitted from preimage
        let calculatedID = try CashuSwift.Keyset.calculateHexKeysetIDv2(keyset: keys,
                                                                        unit: "sat",
                                                                        inputFeePPK: 0,
                                                                        finalExpiry: nil)
